    ...
    return (
        <div className="col-12 overflow-scroll">
            <div className="row g-0 bg-lines text-white text-center odds-list">
                <div className="odds-spanTeam fw-bold" id="statusNba">{props.status}</div>
                ...
                <div className="odds-span">Score {props.awayScore}</div>
            </div>
            <div className={style}>
