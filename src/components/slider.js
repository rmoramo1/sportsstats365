        ...
        <div id="carouselExampleFade" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
                <div className="carousel-item slider slider1 active">
                    <div className="col-12 text-center d-flex justify-content-center align-items-center slider px-3">
                ...
                <div className="carousel-item slider slider3">
                    <div className="text-center d-flex justify-content-center align-items-center slider px-3">
